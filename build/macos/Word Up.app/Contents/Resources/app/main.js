...
function createWindow () {
  ...
  mainWindow = new BrowserWindow({width: screenWidth, height: screenHeight, titleBarStyle: 'hidden-inset'})

  if (!menu) { setMenu(mainWindow) }
  ...
  mainWindow.on('enter-full-screen', function () {
    mainWindow.webContents.send('screen', 'enter-full-screen')
  })

  mainWindow.on('leave-full-screen', function () {
    mainWindow.webContents.send('screen', 'leave-full-screen')
  })
}
